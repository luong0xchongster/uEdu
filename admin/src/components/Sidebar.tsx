...
import { Users, GraduationCap, BookOpen, BarChart3, FileText, Calendar, LogOut, Bot, TrendingUp  } from 'lucide-react'
...
export default function Sidebar() {
  const navigation = [
    ...
    { name: 'AI Exam Generator', href: '/ai-exam-generator', icon: Bot },
